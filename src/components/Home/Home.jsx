...
import profileImage from "../../assets/work_logo/profile2.jpg";

const Home = () => {
    return (
         <section
      id="home"
      className="py-4 max-w-7xl mx-auto font-sans  px-4 sm:px-6 md:px-10  "
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center mt-20">
        ...
        <div className="md:w-1/2  flex justify-center md:justify-end -mt-6">
          <Tilt
            className="w-48 h-30 sm:w-64 sm:h-64 md:w-[30rem] md:h-[30rem] border-4 border-purple-700 rounded-full"
            tiltMaxAngleX={20}
            tiltMaxAngleY={20}
            perspective={1000}
            scale={1.05}
